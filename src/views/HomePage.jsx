  ...
  return (
    <Link to={to} className="group">
      <motion.div
        ...
        className={`relative overflow-hidden rounded-2xl border border-zinc-200 bg-white/60 p-5 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/40 ${gradient}`}
      >
        <div className="flex items-center justify-between">
          ...
          <div className="grid h-12 w-12 place-items-center rounded-2xl border border-zinc-200 bg-white/60 dark:border-zinc-800 dark:bg-zinc-950/30">
...
export function HomePage() {
  return (
    <div className="space-y-10">
      <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white/60 p-8 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/40 md:p-12">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            ...
            className="rounded-full bg-zinc-900 px-5 py-2.5 text-sm font-medium text-zinc-50 shadow-sm transition hover:bg-zinc-800 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-200"
          >
            Shop now
          </Link>
          <Link
            to="/signup"
            className="rounded-full border border-zinc-200 bg-white/60 px-5 py-2.5 text-sm font-medium text-zinc-900 transition hover:bg-white dark:border-zinc-800 dark:bg-zinc-900/50 dark:text-zinc-50 dark:hover:bg-zinc-900"
          >
            Create account
          </Link>
        </div>
