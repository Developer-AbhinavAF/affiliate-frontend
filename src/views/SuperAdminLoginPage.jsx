  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_30px_120px_rgba(0,0,0,0.45)] backdrop-blur">
        <div className="text-2xl font-semibold text-white">Super Admin Login</div>
        <div className="mt-1 text-sm text-white/70">Full control panel access. Username required.</div>
