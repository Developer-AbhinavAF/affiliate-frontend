  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="rounded-3xl border border-zinc-200 bg-white/60 p-6 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/40">
        <div className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50">Super Admin Login</div>
        <div className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Full control panel access. Username required.</div>

        <div className="mt-6 space-y-3">
          <input
            value={username}
            onChange={(e) => setUsername(e.target.value)}
            placeholder="Username (Abhinav)"
